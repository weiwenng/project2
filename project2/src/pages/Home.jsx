      ...
      <div className="icon-list">
        <Card className="card" onClick={() => navigate("/bars_clubs")}>
          <CardContent>
            ...
            <Typography>chillDrink</Typography>
          </CardContent>
        </Card>
        <Card className="card" onClick={() => navigate("/attractions")}>
          <CardContent>
            ...
            <Typography>seeStuff</Typography>
          </CardContent>
        </Card>
        ...
        <Card className="card" onClick={() => navigate("/shops")}>
          <CardContent>
            ...
            <Typography>buyStuff</Typography>
          </CardContent>
        </Card>
        ...
        <Card className="card" onClick={() => navigate("/walking_trail")}>
          <CardContent>
            ...
            <Typography>walkWalk</Typography>
          </CardContent>
        </Card>
        <Card className="card" onClick={() => navigate("/accommodation")}>
          <CardContent>
            ...
            <Typography>goodNight</Typography>
          </CardContent>
        </Card>
